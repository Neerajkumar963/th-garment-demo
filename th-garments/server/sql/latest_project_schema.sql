...
CREATE TABLE `cloth_quantity` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `cloth_detail_id` int(11) NOT NULL,
...
CREATE TABLE `cut_stock` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `cutting_process_id` int(11) NOT NULL,
  `sq` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL CHECK (json_valid(`sq`)),
  `created_on` timestamp NOT NULL DEFAULT current_timestamp(),
  `updated_on` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp(),
  PRIMARY KEY (`id`),
...
CREATE TABLE `cutting_details` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `cutting_process_id` int(11) NOT NULL,
  `cloth_quantity_id` int(11) NOT NULL,
...
CREATE TABLE `cutting_process` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `emp_id` int(11) NOT NULL,
  `org_dress_id` int(11) NOT NULL,
  `order_id` int(11) NOT NULL,
  `sq` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL CHECK (json_valid(`sq`)),
  `pattern_series` varchar(50) DEFAULT NULL,
...
CREATE TABLE `delivery_history` (
  ...
  `org_dress_id` int(11) DEFAULT NULL,
  `created_at` timestamp NOT NULL DEFAULT current_timestamp(),
  PRIMARY KEY (`id`),
  KEY `order_id` (`order_id`),
  KEY `org_dress_id` (`org_dress_id`),
  CONSTRAINT `delivery_history_ibfk_1` FOREIGN KEY (`order_id`) REFERENCES `orders` (`id`) ON DELETE CASCADE,
  CONSTRAINT `delivery_history_ibfk_2` FOREIGN KEY (`org_dress_id`) REFERENCES `org_dress` (`id`) ON DELETE SET NULL
...
CREATE TABLE `orders` (
  ...
  `created_on` timestamp NOT NULL DEFAULT current_timestamp(),
  `updated_on` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp(),
  `dispatch_status` enum('Pending','Packed','Delivered') DEFAULT 'Pending',
...
CREATE TABLE `org_dress` (
  ...
  `item_id` int(11) NOT NULL,
  `color_id` int(11) NOT NULL,
  `material_req` text DEFAULT NULL,
...
CREATE TABLE `processing_details` (
  ...
  `sq` longtext NOT NULL,
  `emp_id` int(11) DEFAULT NULL,
  `stage_id` int(11) NOT NULL,
  `processing_rate` decimal(10,2) DEFAULT NULL,
  `status` enum('in_process','processed') DEFAULT 'in_process',
  `remarks` text DEFAULT NULL,
  `created_on` timestamp NOT NULL DEFAULT current_timestamp(),
  `updated_on` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp(),
  PRIMARY KEY (`id`),
...
CREATE TABLE `receipt_logs` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `receipt_format_id` int(11) NOT NULL,
...
) ENGINE=InnoDB AUTO_INCREMENT=6025 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
ALTER TABLE cloth_quantity 
    ADD COLUMN unit ENUM('Kg.', 'Mtr.') DEFAULT 'Mtr.';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2026-02-18 11:21:39
